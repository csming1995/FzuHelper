...
import com.helper.west2ol.fzuhelper.activity.CourseDetailsActivity;
    ...
    public View onCreateView(LayoutInflater inflater , ViewGroup container , Bundle savedIntanceState){
        ...
        menu_button_in_course_table.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("CourseTable","menuButton onClick");
...
//                            getResources().getDrawable(R.drawable.course_table_last_colum));
        ...
        for (int i=0;i<kcs.size();i++) {
            ...
            final String title = kc.getKcName();
            final String location = kc.getKcLocation();
            final String teacher = kc.getKcTeacher();
            final int startTime = kc.getKcStartTime();
            final int endTime = kc.getKcEndTime();
            final int startWeek = kc.getKcStartWeek();
            final int endWeek = kc.getKcEndWeek();
            final String type = kc.getKcType();
            final int backgroundId = background[kc.getKcBackgroundId()];
